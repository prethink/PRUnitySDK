...
public static class GameRules
{
    ...
    /// <summary>
    /// ѕримен€ет все правила, относ€щиес€ к указанной характеристике, к текущему значению.
    /// </summary>
    ...
    /// <summary>
    /// ѕримен€ет правила к характеристике и округл€ет результат до типа long.
    /// </summary>
    ...
    /// <summary>
    /// ѕримен€ет правила к характеристике и округл€ет результат до типа int.
    /// </summary>
