...
/// </summary>
/// <remarks>
/// Компонент вешается на объект сущности рядом с ней. Сущность находит его при сборке
/// описания и подставляет как <c>Override</c>-описание поверх базового, поэтому подменить
/// можно часть полей, не трогая остальные - например, дать конкретному экземпляру
/// собственную иконку.
/// </remarks>
