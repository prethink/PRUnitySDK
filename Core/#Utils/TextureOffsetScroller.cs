...
/// <remarks>
/// <para>
/// Сдвиг задаётся через <c>MaterialPropertyBlock</c>, а не через <c>renderer.material</c>.
/// Разница существенная: обращение к <c>material</c> создаёт объекту личную копию
/// материала, которая живёт до конца сцены и никогда не уничтожается, и заодно выбивает
/// объект из общей отрисовки. Блок свойств меняет то же самое, ничего не создавая.
/// </para>
/// <para>
