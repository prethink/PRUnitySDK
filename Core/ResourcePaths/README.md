...
Переиспользуемые пути размещайте в публичном `PRUnitySDK`. Пути к ресурсам конкретной
игры держите рядом с их модулем в проектном слое, не добавляя его зависимости
в публичное ядро.
