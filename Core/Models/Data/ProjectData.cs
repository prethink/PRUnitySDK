...
public partial class ProjectData : ICloneable
{
    ...
    /// <para>
    /// Лежат отдельным словарём, поэтому ключи наград не пересекаются с произвольными
    /// DateTime-свойствами проекта, а сами награды можно перечислить и очистить разом.
    /// </para>
    /// </summary>
