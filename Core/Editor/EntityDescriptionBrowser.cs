...
/// <para>
/// Ассеты ищутся по проекту, а не берутся из каталога: список в каталоге приходится
/// вести руками, и он расходится с проектом. К моменту, когда это заметили, в базе
/// было 6 описаний из 8 существующих.
/// </para>
/// </remarks>
