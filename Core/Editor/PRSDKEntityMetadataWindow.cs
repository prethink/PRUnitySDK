...
/// отдельным ассетом, у предметов каталога прямо в определении.
/// <para>
/// Ассеты ищутся по проекту, а не по каталогу SDK: каталог приходилось вести руками,
/// и он расходился с проектом.
/// </para>
/// </remarks>
