...
временем. Для каждой записи видны
категория, имя, тип контракта, фактический тип реализации и время операции; сверху
показано суммарное отслеживаемое время. Общий поиск фильтрует записи по всем этим полям.
