...
в проекте. Стандартный метод в таком случае возвращает ноль, и физика перестаёт
находить что-либо вообще, без единой ошибки в консоли, поэтому причину искать долго.
